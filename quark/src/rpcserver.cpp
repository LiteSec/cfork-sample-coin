...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Cforksamplecoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Cforksamplecoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cforksamplecoin features */
        {"cforksamplecoin", "masternode", &masternode, true, true, false},
        {"cforksamplecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cforksamplecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cforksamplecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cforksamplecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cforksamplecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cforksamplecoin", "startmasternode", &startmasternode, true, true, false},
        {"cforksamplecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cforksamplecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cforksamplecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cforksamplecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cforksamplecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cforksamplecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cforksamplecoin", "mnbudget", &mnbudget, true, true, false},
        {"cforksamplecoin", "preparebudget", &preparebudget, true, true, false},
        {"cforksamplecoin", "submitbudget", &submitbudget, true, true, false},
        {"cforksamplecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cforksamplecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cforksamplecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cforksamplecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cforksamplecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cforksamplecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cforksamplecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cforksamplecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cforksamplecoin", "mnsync", &mnsync, true, true, false},
        {"cforksamplecoin", "spork", &spork, true, true, false},
        {"cforksamplecoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cforksamplecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cforksamplecoind, or the -server option to cforksamplecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cforksamplecoin-cli " + methodname + " " + args + "\n";
}

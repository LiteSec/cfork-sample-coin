                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cforksamplecoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cforksamplecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cforksamplecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cforksamplecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cforksamplecoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cforksamplecoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cforksamplecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cforksamplecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cforksamplecoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cforksamplecoin Core help message to get a list with possible Cforksamplecoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cforksamplecoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cforksamplecoin network", "", count));
}
...
{
    QString strTitle = tr("Cforksamplecoin Core"); // default title
    ...
    // Append title to "Cforksamplecoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

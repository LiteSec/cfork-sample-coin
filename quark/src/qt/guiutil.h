...
/** Utility functions used by the Cforksamplecoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Cforksamplecoin addresses in monospace font
...
// Parse "cforksamplecoin:" URI into recipient object, return true on successful parsing

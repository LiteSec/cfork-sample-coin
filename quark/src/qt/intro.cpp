...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cforksamplecoin Core"),
     ...
     * override -datadir in the cforksamplecoin.conf file in the default data directory
     * (to be consistent with cforksamplecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

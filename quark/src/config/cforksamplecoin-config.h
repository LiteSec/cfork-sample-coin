/* src/config/cforksamplecoin-config.h.  Generated from cforksamplecoin-config.h.in by configure.  */
/* src/config/cforksamplecoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.cforksamplecoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cforksamplecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cforksamplecoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cforksamplecoin"

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cforksamplecoin Core cforksamplecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cforksamplecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cforksamplecoin transaction") + "\n" +
                               "  cforksamplecoin-tx [options] -create [commands]   " + _("Create hex-encoded cforksamplecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cforksamplecoin transaction

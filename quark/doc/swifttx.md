...
This mechanism has been integrated into Bitcore-Node-Cforksamplecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Cforksamplecoin-Project/insight-api-cforksamplecoin#web-socket-api](https://github.com/Cforksamplecoin-Project/insight-api-cforksamplecoin#web-socket-api) 
* API: [https://github.com/Cforksamplecoin-Project/insight-api-cforksamplecoin#swifttx-transactions](https://github.com/Cforksamplecoin-Project/insight-api-cforksamplecoin#swifttx-transactions) 
...
By default, the Cforksamplecoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cforksamplecoin Core daemon:

...
In order to support loading of multiple wallets in cforksamplecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cforksamplecoin.cpp.
...
Changes to cforksamplecoin.cpp
----------------------
cforksamplecoin.cpp is the entry point into cforksamplecoin-qt, and as such, will require some minor modifications to provide hooks for
